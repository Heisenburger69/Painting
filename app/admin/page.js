    ...
    <div>
      ...
      <div className="admin-table-wrap orders-table">
        <table>
          <thead>
            <tr>
              <th>ID</th><th>Name</th><th>Email</th><th>Phone</th><th>Address</th><th>Total</th><th>Artworks</th><th>Status</th><th>Date</th><th>Actions</th>
            </tr>
          </thead>
          <tbody>
            {filtered.length === 0 && (
            ...
            {filtered.map((o) => (
              <tr key={o.id}>
                ...
                <td className="order-name-cell">{o.buyer_name}</td>
                <td className="order-email-cell">{o.buyer_email}</td>
                <td className="order-phone-cell">{o.shipping_address?.phone || '\u2014'}</td>
                ...
                {/* Mobile card */}
                <td colSpan={10} className="order-mobile-card">
                  ...
                  <div className="order-customer-row">
                    <strong>{o.buyer_name}</strong> · {o.buyer_email} · {o.shipping_address?.phone || '\u2014'}
                  </div>
                  ...
                  <div className="order-footer">
                    ...
                    <button onClick={() => handleDelete(o.id)} disabled={busy} className="order-remove-btn"
                      style={{ padding: '4px 10px', border: 'none', borderRadius: 4, background: 'var(--caput-mortuum)', color: '#fff', cursor: 'pointer' }}>
                      Remove
                    </button>
                  </div>
                </td>
